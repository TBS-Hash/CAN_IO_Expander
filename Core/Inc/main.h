...
#define GPI_Sensor_3_EXTI_IRQn EXTI4_15_IRQn
#define GPI_Sensor_2_Pin GPIO_PIN_0
#define GPI_Sensor_2_GPIO_Port GPIOA
#define GPI_Sensor_2_EXTI_IRQn EXTI0_1_IRQn
#define GPI_Sensor_s1_Pin GPIO_PIN_1
#define GPI_Sensor_s1_GPIO_Port GPIOA
#define GPI_Sensor_s1_EXTI_IRQn EXTI0_1_IRQn
...
#define SM_GPIO26_EXTI_IRQn EXTI4_15_IRQn
